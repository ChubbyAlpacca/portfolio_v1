    ...
    <section id="contact" className="content-center">
      ...
      >
        <form
          ...
          className="lg:w-1/3 md:w-1/2 flex tems-center justify-center w-screen flex-col "
        >
          <h2 className="text-red-500 sm:text-4xl text-3xl mb-1 font-medium title-font">
            Hire Me
          </h2>
